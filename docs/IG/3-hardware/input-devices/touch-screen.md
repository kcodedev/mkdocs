...
```mermaid
graph LR;
    A[Touch Screen 📱] --> B[Resistive 👆];
    A --> C[Capacitive ⚡];
    A --> D[Infra-red 💥];
    B --> E[Pressure Sensitive];
    C --> F[Capacitance Change];
    D --> G[Light Beam Interruption];
```
...
![Capacitive Touch Screen](https://i0.wp.com/www.orientdisplay.com/wp-content/uploads/2021/03/3.png?w=600&ssl=1)
<br>*(image to be updated)*
...
![Infra-red Touch Screen](https://www.canvys.com/wp-content/uploads/2020/07/IR_01.jpg)
<br>*(image to be updated)*
